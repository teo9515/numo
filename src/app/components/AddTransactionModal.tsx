  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className="bg-orange-500 text-white h-12 w-[180px] rounded-lg font-normal hover:bg-orange-600 transition-colors text-sm tracking-[2px] hover:cursor-pointer"
      >
        Nueva transacción
      </button>
